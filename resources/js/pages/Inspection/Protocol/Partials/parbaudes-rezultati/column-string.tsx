...
const ColumnString = ({ title, value = 0 }: { title: string; value?: number }) => {
    return (
        <View style={styles.wrapper}>
            ...
            <View style={styles.columnValuesWrapper}>
                <View style={styles.columnValues}>
                    <Text style={styles.columnValuesText}>{value == 0 ? 'X' : ''}</Text>
                </View>
                <View style={styles.columnValues}>
                    <Text style={styles.columnValuesText}>{value == 1 ? 'X' : ''}</Text>
                </View>
                <View style={styles.columnValues}>
                    <Text style={styles.columnValuesText}>{value == 2 ? 'X' : ''}</Text>
                </View>
                <View style={styles.columnValuesLast}>
                    <Text style={styles.columnValuesText}>{value == 3 ? 'X' : ''}</Text>
                </View>
            </View>
        </View>
    );
