        ...
        <View style={styles.wrapper}>
            <View style={styles.textBlockWrapper}>
                <View style={styles.firstLine}>
                    <Text style={styles.firstLineText}>LATVIJAS RŪPNIEKU TEHNISKĀS DROŠĪBAS EKSPERTU APVIENĪBA</Text>
                </View>
                <View style={styles.secondLine}>
                    <Text style={styles.secondLineText}>TUV Rheinland grupa, SIA</Text>
                </View>
                <View style={styles.thirdLine}>
                    <Text style={styles.thirdLineText}>
                        Katlakalna iela 9A, Rīga, LV-1073, Latvija, Tālr. 67568607, www.tuv.lv, e-pasts: tuv@tuv.lv
                    </Text>
                </View>
                <View style={styles.fourthLine}>
                    <Text style={styles.fourthLineText}>DARBA AIZSARDZĪBAS UN IEKĀRTU NOVĒRTĒŠANAS INSPEKCIJA</Text>
                </View>
            </View>
