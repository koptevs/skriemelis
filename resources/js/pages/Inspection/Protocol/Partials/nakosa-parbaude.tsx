...
const NakosaParbaude = ({ dateStart, dateEnd }: { dateStart: string; dateEnd: string }) => {
    return (
        <>
            <View style={{ ...styles.wrapper, marginTop: '3mm' }}>
                ...
                >
                    <Text style={styles.textSansBold}>{dayjs(dateEnd).add(1, 'year').format('DD.MM.YYYY')}</Text>
                </View>
                <View
                    style={{
                        width: '75mm',
                ...
                >
                    <Text style={styles.textSansBold}>Pieļaujamā celtspēja</Text>
                </View>
                <View
                    style={{
                        width: '35mm',
